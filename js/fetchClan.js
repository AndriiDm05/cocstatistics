...
async function fetchClan() {
    ...
    try {
        ...
        const res = await fetch(`https://cocstatistics.onrender.com/api/clan/${tag}`);
        ...
        const membersRes = await fetch(`https://cocstatistics.onrender.com/api/clan/${tag}/members`);
...
async function fetchCurrentWar() {
    ...
    try {
        ...
        const res = await fetch(`https://cocstatistics.onrender.com/api/clan/${tag}/currentwar`);
        if (!res.ok) throw new Error(await res.text());
        const data = await res.json();
